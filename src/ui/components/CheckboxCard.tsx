  ...
  return (
    <SubframeCore.Checkbox.Root asChild={true} {...otherProps}>
      ...
      >
        ...
        >
          <FeatherCheck className="hidden font-body text-[14px] text-white leading-[14px] group-disabled/de0b4dfb:text-neutral-400 group-aria-[checked=true]/de0b4dfb:inline-flex group-aria-[checked=true]/de0b4dfb:font-body group-aria-[checked=true]/de0b4dfb:text-[16px] group-aria-[checked=true]/de0b4dfb:leading-[16px] group-aria-[checked=true]/de0b4dfb:tracking-normal" />
        </div>
        {children ? (
