...
/*
 * Documentation:
 * Button — https://app.subframe.com/84ec9af13098/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
        ...
        >
          <SubframeCore.Loader
            className={SubframeUtils.twClassNames(
              ...
              {
                'inline-block font-caption leading-[20px]': loading,
